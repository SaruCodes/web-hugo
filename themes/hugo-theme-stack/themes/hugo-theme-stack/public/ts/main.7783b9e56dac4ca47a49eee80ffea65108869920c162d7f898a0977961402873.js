(() => {
  // ns-hugo:/home/sara/personal-blog/themes/hugo-theme-stack/assets/ts/gallery.ts
  ...
  // ns-hugo:/home/sara/personal-blog/themes/hugo-theme-stack/assets/ts/color.ts
  var colorsCache = {};
  if (localStorage.hasOwnProperty("StackColorsCache")) {
    try {
      colorsCache = JSON.parse(localStorage.getItem("StackColorsCache") || "{}");
    } catch (e) {
      console.error("Failed to parse color cache:", e);
      colorsCache = {};
    }
  }
  async function getColor(key, hash, imageURL) {
    ...
    if (!colorsCache.hasOwnProperty(key) || colorsCache[key].hash !== hash) {
      ...
      const vibrant = palette.Vibrant || { hex: null, rgb: null, bodyTextColor: null };
      const darkMuted = palette.DarkMuted || { hex: null, rgb: null, bodyTextColor: null };
      colorsCache[key] = {
        hash,
        Vibrant: vibrant,
        DarkMuted: darkMuted
  ...
  // ns-hugo:/home/sara/personal-blog/themes/hugo-theme-stack/assets/ts/menu.ts
  ...
  // ns-hugo:/home/sara/personal-blog/themes/hugo-theme-stack/assets/ts/createElement.ts
  ...
  // ns-hugo:/home/sara/personal-blog/themes/hugo-theme-stack/assets/ts/colorScheme.ts
  ...
  // ns-hugo:/home/sara/personal-blog/themes/hugo-theme-stack/assets/ts/scrollspy.ts
  ...
  // ns-hugo:/home/sara/personal-blog/themes/hugo-theme-stack/assets/ts/smoothAnchors.ts
